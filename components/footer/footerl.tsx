    ...
    return(
      <footer className=" bg-mintGreen  ">
        <div className="mx-5  tablet:mx-auto tablet:container py-20 flex flex-col items-start space-y-5 tablet:flex-row tablet:space-y-0 tablet:py-32 tablet:justify-between ">
                   <div className="w-full justify-center text-white font-lufga-bold text-2xl md:text-4xl tablet:w-2/3 lg:text-5xl flex flex-col md:space-y-2">
                       <h1 className="text-center text-xs  tablet:text-base py-5 md:py-0 font-bold">DEVy</h1>
