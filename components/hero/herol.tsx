...
const Herol=()=>{
    ...
    return(
        <section id='herol' className="  bg-primary w-full h-full text-white mobile:hidden tablet:flex">
              ...
              <div className="w-1/2   mobile:h-screen   text-center flex flex-col justify-center">
                <p className="uppercase text-mintGreen font-bold p-2">Growing with Devy app</p>
              ...
              <div className='w-1/2 tablet:mx-auto flex justify-end  '>
